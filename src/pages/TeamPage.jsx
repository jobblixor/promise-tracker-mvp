...
function MemberCard({ member, isOwner, currentUserId, onRemove, onRoleChange }) {
  ...
  return (
    <div className={`group bg-bg-card border border-border/40 shadow-sm rounded-xl p-5 hover:border-border/70 hover:bg-bg-card-hover transition-all duration-200 animate-fade-in-up ${roleDropdown ? 'relative z-30' : ''}`}>
