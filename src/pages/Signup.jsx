    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center px-4">
      <div className="w-full max-w-sm animate-fade-in-up">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-text-muted mt-1.5">{invite ? 'Complete your account to get started' : "You'll get a welcome text with your Promise Tracker number. Text your first promise to get started."}</p>
        </div>
