    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <article className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="space-y-6 text-gray-600 leading-relaxed">
          ...
          <p>
            The issue isn't motivation — it's that there's no system tracking which quotes are open and when the next follow-up is due. That's exactly what <Link to="/signup" className="text-green-600 font-medium hover:text-green-700">Promise Tracker</Link> was built for. Text a promise to your Promise Tracker number in plain English, and the system sends automatic text and email reminders until you get a definitive yes or no. No more sticky notes, no more forgotten estimates, no more money left on the table.
          </p>
          <p>
